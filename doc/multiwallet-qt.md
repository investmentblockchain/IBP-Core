...
Only requiring some minor changes is icpro.cpp.
...
Changes to icpro.cpp
----------------------
icpro.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
