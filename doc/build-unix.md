UNIX BUILD NOTES
====================
Some notes on how to build ICPro Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Note
---------------------
Always use absolute paths to configure and compile ICPro Core and the dependencies,
...
memory available when compiling ICPro Core. With 512MB of memory or less
...
See the section "Disable-wallet mode" to build ICPro Core without wallet.
...
Security
--------
To help make your ICPro installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, ICPro Core should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, ICPro Core may be compiled in
