    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("IBP Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IBP address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About IBP Core"), this);
    aboutAction->setStatusTip(tr("Show information about IBP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IBP Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IBP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IBP addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the IBP Core help message to get a list with possible IBP Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("IBP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IBP network", "", count));
    } else {
...
{
    QString strTitle = tr("IBP Core"); // default title
