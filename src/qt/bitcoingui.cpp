    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("ICPro Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ICPro address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and icpro: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About ICPro Core"), this);
    aboutAction->setStatusTip(tr("Show information about ICPro Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ICPro Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ICPro addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ICPro addresses"));
    ...
    openAction->setStatusTip(tr("Open a icpro: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ICPro Core help message to get a list with possible ICPro Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("ICPro Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ICPro network", "", count));
    } else {
...
{
    QString strTitle = tr("ICPro Core"); // default title
