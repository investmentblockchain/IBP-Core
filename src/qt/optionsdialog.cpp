    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("IBP-light"), QVariant("light"));
    ui->theme->addItem(QString("IBP-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("IBP-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("IBP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("IBP-traditional"), QVariant("trad"));
...
void OptionsDialog::on_resetButton_clicked()
{
    if(model)
    {
        ...
        QMessageBox::StandardButton btnRetVal = QMessageBox::question(this, tr("Confirm options reset"),
            tr("Client restart required to activate changes.") + "<br><br>" + tr("Client will be shut down. Do you icpro to proceed?"),
