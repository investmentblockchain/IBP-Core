...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(IBP);
    unitlist.append(mICP);
    unitlist.append(uICP);
...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            ...
            case mICP: return QString("mICP");
            case uICP: return QString::fromUtf8("μIBP");
    ...
    else
    {
        switch(unit)
        {
            case IBP: return QString("tICP");
            case mICP: return QString("mtICP");
            case uICP: return QString::fromUtf8("μtICP");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case IBP:  return 100000000;
    case mICP: return 100000;
    case uICP: return 100;
    case duffs: return 1;
