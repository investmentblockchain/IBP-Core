    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  ibp-qt [" + tr("command-line options") + "]                     " + "\n";
...
PrivateSend uses an innovative process to mix your inputs with the inputs of two other ibp, without having your coins ever leave your wallet. \
...
<li>When two other ibp send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
