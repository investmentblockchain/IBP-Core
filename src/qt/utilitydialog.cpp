    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("IBP Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About IBP Core"));
...
All the IBP in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://IBPDev.atlassian.net/wiki/display/DOC/PrivateSend\">https://IBPDev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("IBP Core is shutting down...") + "<br /><br />" +
