    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("ICPro Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About ICPro Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  icpro-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the ICPro in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other icpro, without having your coins ever leave your wallet. \
...
These denominations are 0.01 IBP, 0.1 IBP, 1 IBP and 10 IBP -- sort of like the paper money you use every day.</li> \
...
<li>When two other icpro send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://ICProDev.atlassian.net/wiki/display/DOC/PrivateSend\">https://ICProDev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("ICPro Core is shutting down...") + "<br /><br />" +
