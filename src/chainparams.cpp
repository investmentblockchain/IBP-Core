...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 2000; // Note: actual number of blocks per calendar year with DGW v3 is ~200700 (for example 449750 - 249050)
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000b3244f82e350");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000000016a980d2b6a6a93030fa7187bd343866e0bc5bd869ef70f186b800a3");
        ...
        genesis = CreateGenesisBlock(1527177130, 882140, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000b437d6e2c4a0831584673bf7b19bf523a0d736bb1cf1b74fe2b5a9d3e28"));
        assert(genesis.hashMerkleRoot == uint256S("0x1f2190de4f22108a4ee53b593f4f46070d53921cfd0dbf45882117c6238937c7"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  1674, uint256S("0x00000000041402522849a69c4a092bc110c8f74df6ab33293b1e21e98eabbce2"))
            (  1690, uint256S("0x0000000016a980d2b6a6a93030fa7187bd343866e0bc5bd869ef70f186b800a3")),
            1527715066, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("046aec05df0957ce1851e2b8bbe516522b6c7f668d027387488fc824370b9361958d6bff4b4225cf11b0e7a85fdf3e173ca13c741429f9c8c9ced1d45c56aabbc6");
        nDefaultPort = 4020;
        nMaxTipAge = 0x7fffffff; // allow mining on top of old blocks for testnet
        nDelayGetHeadersTime = 24 * 60 * 60;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1527177131, 457376, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000005d9ae75a244837abd0ab73e9eb52fd43a83b1fefc25b0a07b364154006c"));
        assert(genesis.hashMerkleRoot == uint256S("0x1f2190de4f22108a4ee53b593f4f46070d53921cfd0dbf45882117c6238937c7"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x000005d9ae75a244837abd0ab73e9eb52fd43a83b1fefc25b0a07b364154006c")),
            1527177131, // * UNIX timestamp of last checkpoint block
            0,       // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1527177132, 3, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4e0d35fffb804ed13f419ddc4efcef9fa30537962af84f772a1be25fbfc7c695"));
        assert(genesis.hashMerkleRoot == uint256S("0x1f2190de4f22108a4ee53b593f4f46070d53921cfd0dbf45882117c6238937c7"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x4e0d35fffb804ed13f419ddc4efcef9fa30537962af84f772a1be25fbfc7c695")),
            0,
            0,
            0
        };
